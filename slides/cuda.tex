...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \only<1>{\includegraphics[width=0.55\textwidth]{out/pdf/svg/cuda_shmem_1.pdf}}%
    \only<2>{\includegraphics[width=0.55\textwidth]{out/pdf/svg/cuda_shmem_2.pdf}}%
    \only<3->{\includegraphics[width=0.55\textwidth]{out/pdf/svg/cuda_shmem_3.pdf}}%
  \end{center}
\end{frame}
