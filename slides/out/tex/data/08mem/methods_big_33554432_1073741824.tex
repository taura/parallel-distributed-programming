...
\begin{picture}(5102.00,3118.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2702,2877){\makebox(0,0){\strut{}list traversal vs random access vs sequential access [33554432,1073741824]}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={255.10bp},height={155.90bp}]{out/tex/data/08mem//methods_big_33554432_1073741824}}%
    \gplfronttext
  \end{picture}%
\endgroup
