...
\begin{picture}(5102.00,3118.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2750,2877){\makebox(0,0){\strut{}summary of various access patterns [0,1073741824]}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={255.10bp},height={155.90bp}]{out/tex/data/08mem//summary_big_0_1073741824}}%
    \gplfronttext
  \end{picture}%
\endgroup
